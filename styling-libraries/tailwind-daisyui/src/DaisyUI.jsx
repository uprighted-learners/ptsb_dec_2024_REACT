...
const DaisyUI = () => {
  return (
    <div data-theme="" className="min-h-screen bg-base-100 text-base-content">
      {/* Navbar */}
      ...
      <dialog id="my_modal_2" className="modal">
            ...
            <div className="  hero min-h-[60vh] bg-gradient-to-tr from-base via-primary to-secondary text-base-100"
                ...
                <div className="text-center z-1  p-20 rounded-2xl">
                    ...
                    <p className="py-6">Building modern experiences with speed and style.</p>
                    <div className='flex justify-center gap-2'>

                        <button className="btn btn-primary text-base-100">Get Started</button>
                        <button className="btn btn-secondary" onClick={() => document.getElementById('my_modal_2').showModal()}>Open Modal</button>
                    </div>
                </div>
            </div>
            <div className="hero min-h-[60vh] bg-secondary text-base-100">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div className="w-full max-w-md">
                        ...
                        <p className="py-4">Sign up to start building modern experiences.</p>
                    ...
                    <div key={idx} className="card bg-base-100 shadow-xl">
                        <div className="card-body">
                            ...
                            <div className="card-actions justify-end">
                                <button className="btn btn-sm btn-info text-base-100">Learn More</button>
                            </div>
                        </div>
                    </div>
                ))}
            ...
            <div className="p-6">
                <div className="alert alert-info text-base-content">
                    <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18.364 5.636l-12.728 12.728M5.636 5.636l12.728 12.728" /></svg>
            ...
            {/*//? Timeline */}
            <div className="p-6">
                <div className="text-xl font-bold mb-4 text-neutral">Deployment Timeline</div>
                <ul className="timeline timeline-vertical">
                    <li>
                        <div className="timeline-start">Dev</div>
                        <div className="timeline-middle bg-primary w-5 h-5 rounded-full"></div>
                        <div className="timeline-end timeline-box">Development Phase Complete</div>
                    </li>
                    <li>
                        <div className="timeline-start">QA</div>
                        <div className="timeline-middle bg-secondary w-5 h-5 rounded-full"></div>
                        <div className="timeline-end timeline-box">Quality Assurance Tested</div>
                    </li>
                    <li>
            ...
            <footer className="footer sm:footer-horizontal bg-base-300 text-base-content p-10">
                ...
                <nav>
                    ...
                    <div className="grid grid-flow-col gap-4">
                        <a>
                            {/* <FontAwesomeIcon className='cursor-pointer' icon={faTwitter} size='2xl' /> */}

                        </a>
                        <a>
                            {/* <FontAwesomeIcon className='cursor-pointer' icon={faYoutube} size='2xl' /> */}
                        </a>
                        <a>
                            {/* <FontAwesomeIcon className='cursor-pointer' icon={faFacebook} size='2xl' /> */}
                        </a>
                    </div>
                </nav>
            </footer>
