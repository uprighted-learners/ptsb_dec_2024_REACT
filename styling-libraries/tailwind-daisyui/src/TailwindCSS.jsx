...
const TailwindCSS = () => {
    ...
    return (
        <>
            ...
            <nav className="bg-accent text-black px-4 shadow-md sticky top-0 z-50 py-4">
            ...
            <section className="bg-secondary text-base px-6 py-20 text-center md:text-left">
                <div className="max-w-4xl mx-auto">
                    ...
                    <button className="bg-accent hover:bg-base text-white px-6 py-3 rounded-lg font-semibold">
                        Get Started
                    </button>
                </div>
            </section>
            ...
            <div className="flex  items-center justify-center bg-primary px-4 py-8">
                <form className="bg-white text-black shadow-md rounded-lg p-8 w-full max-w-sm border border-accent">
                    ...
                    />
                    <button className="w-full bg-accent hover:bg-base text-white py-2 rounded font-semibold">
                        Sign In
                    </button>
                </form>
            </div>

            <div className=" mx-auto p-4 bg-secondary h-full w-full">
                <div className="mx-auto max-w-sm bg-white shadow-lg rounded-2xl overflow-hidden border border-secondary">
                    <img
                    ...
                    />
                    <div className="p-4">
                        <h2 className="text-xl font-bold text-base">Featured Item</h2>
                        <p className="text-base text-sm">Beautifully styled using your custom palette.</p>
                        <button className="mt-4 bg-accent hover:bg-base text-white px-4 py-2 rounded">
                            View More
                        </button>
                    </div>
                </div>
